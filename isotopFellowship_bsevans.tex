...
The interaction between human land use and the life history traits of species determines whether a given species will be a "winner"Äù (urban-adapted species) or "loser"Äù in human-dominated landscapes (urban-avoiding species; McKinney and Lockwood 1999; Blair 2001). It is hypothesized that bird populations and communities in anthropogenic environments are largely structured by the distribution of resources accessible to a given dietary guild (Shochat et al. 2010, Evans et al. 2015). Species with specialist dietary requirements, especially obligate insectivores (Lancaster and Rees 1979), are expected to be sensitive to human-induced habitat modification and may therefore experience high rates of local extinction across the urban habitat matrix (Devictor et al. 2007). Conversely, species with generalist dietary habitats and those that have the ability to utilize anthropogenic resources (e.g., granivores utilizing bird feeders, Robb et al. XXXX) are expected to be positively affected by urbanization (reviewed in McKinney and Lockwood 1999). For example, urban landscapes are often dominated by ornamental and non-native species

The ornamental and invasive species provide an especially compelling example of the ... that provide essential resources for frugivorous bird species during winter months and thus may facilitate winter survival (e.g., Leston and Rodewald 2006, McCusker et al. 2010) but have been shown to support reduced arthropods during the growing season and thus are expected to negatively influence insectivores (citation XXXX).

Despite expectations that urban environments can present opposing selection pressures, our understanding of the processes  that regulate species in urban landscapes are largely unknown. Studies of avian survival across life history stages (e.g., post-fledging survival, Balogh et al. 2011, nestling survival, Ryder et al. 2010, and adult Evans et al. 2015) have provided evidence that species exhibit differential rates of survival but the mechanisms driving this response have yet to be directly explored.
...
\noindent \textit{Analysis}: I will use Structural Equation Modeling (SEM; McCune and Grace 2002) to examine hypothesized relationships between habitat features, bird health, and dietary habits (below). SEM is a multivariate technique that allows us to simultaneously analyze the complex, and often correlated, inter-relationships among measured (e.g., CORT and land-cover) and latent variables (i.e., those estimated from measured values such as niche width). We will use a Bayesian framework to develop and test \textit{a priori} SEM in JAGS, implemented in Program R (see Plummer et al. 2003). We will evaluate the influence of structural linkages using Markov chain Monte Carlo sampling and use Bayesian model selection to compare \textit{a priori} models (see Raferty 1993). With SEM, we will distinguish the relative influence of local and regional scale environmental attributes on bird health and dietary traits. 
